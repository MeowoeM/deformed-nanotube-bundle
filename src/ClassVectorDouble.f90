module ClassVectorDouble
    ...
    type VectorDouble
        ...
        !!<member name="isinitializeVectorDoubled">whether the vector is initializeVectorDoubled</member>
        logical, private :: isinitializeVectorDoubled = .false.
    contains
...
contains
    ...
    subroutine append(this, element)
        class(VectorDouble) :: this
        doubleprecision, intent(in) :: element
        doubleprecision, dimension(:), allocatable :: listTmp

        if ( this%isinitializeVectorDoubled .eqv. .false. ) then
    ...
    subroutine writeVector(this, outUnit)
        ...
        doubleprecision, dimension(:), allocatable :: v
